...
interface ILaureateRepository {
   ...
   */
  getLaureateById(id:string): LaureateModel;

  /**
   * Return the laureate by the first name.
   * @param {string} firstName The first name.
   */
  getLaureatesByFirstName(firstName:string): Array<LaureateModel>;

  /**
   * Return the laureate by the surname.
   * @param {string} surname The surname.
   */
  getLaureatesBySurname(surname:string): Array<LaureateModel>;
}
